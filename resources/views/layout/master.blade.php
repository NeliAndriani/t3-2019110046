...
<body>
 ...
 <a href="http://t3-2019110046.test/relations/find"
 class="bg-white list-group-item list-group-item-action">
 <div class="d-flex w-100 justify-content-start align-items-center">
 <span class="fa fa-film fa-fw mr-3"></span>
 <span class="menu-collapsed">Relations 1 (find)</span>
 </div>
 </a>

 <a href="http://t3-2019110046.test/relations/all-join"
 class="bg-white list-group-item list-group-item-action">
 <div class="d-flex w-100 justify-content-start align-items-center">
 <span class="fa fa-film fa-fw mr-3"></span>
 <span class="menu-collapsed">Relations 2 (all-join)</span>
 </div>
 </a>

 <a href="http://t3-2019110046.test/relations/with-count"
 class="bg-white list-group-item list-group-item-action">
 <div class="d-flex w-100 justify-content-start align-items-center">
 <span class="fa fa-film fa-fw mr-3"></span>
 <span class="menu-collapsed">Relations 3 (with-count)</span>
 </div>
 </a>
